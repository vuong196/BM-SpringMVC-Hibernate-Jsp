		...
		<div class="col-md-offset-2 col-md-7">
			...
			<div class="panel panel-info">
				...
				<div class="panel-heading">
					<div class="panel-title">Edit Book Form</div>
				</div>
				<div class="panel-body">
					...
					<form:form action="save" cssClass="form-horizontal" method="post" modelAttribute="book">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<form:select path="bookCategorySet" multiple="true" items="${categoryList}" itemValue="categoryId" itemLabel="categoryName"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<form:select path="bookAuthor" items="${authorList}" itemValue="authorId" itemLabel="authorName"/>
							</div>
						</div>
